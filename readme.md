...
## CAT4004 class
The CAT4004 class is a simple Interface to set the LED brgihtness controlled by a CAT4004
...
### process
The task funktion. It should be called in a less than 10 ms intervall.
...
E.g. Requesting a brigtness of 15% will resalt in 20 % will result in 12.5 % on a CAT4004 and in 19.4% on a CAT4004B.    	
